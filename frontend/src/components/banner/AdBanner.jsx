  ...
  const sections = [
    {
      ...
      description: "Indulge in our delicious special pizzas with fresh toppings and cheesy goodness. Grab your favorite today!",
      imageUrl: advPizza,
      reverse: false,
    },
    {
      ...
      description: "Enjoy hearty and wholesome meal combos designed to satisfy your cravings. Order now and relish the flavors!",
      imageUrl: advCombo,
      reverse: true,
    },
    {
      id: 3,
      title: "Non-Veg Feast",
      description: "Dive into our special non-veg dishes, crafted with premium quality ingredients for a delightful experience.",
      imageUrl: advNonVeg,
      reverse: false,
    },
  ];
      ...
      {sections.map((section) => (
        ...
        >
          ...
          <div className="px-6 md:px-10 lg:px-14 py-6 md:py-14 lg:py-30 text-center">
            ...
            <button className="px-4 py-2 bg-red-500 text-white text-lg rounded-lg shadow-md hover:bg-red-600 transition">Explore Now</button>
          </div>
        </div>
      ))}
    </div>
